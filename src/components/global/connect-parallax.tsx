...
export const HeroParallax = ({
  ...
  const translateY = useSpring(
    useTransform(scrollYProgress, [0, 0.2], [-580, 50]),
  ...
  return (
    <div
      ref={ref}
      className="relative flex h-full flex-col self-auto overflow-hidden py-40 antialiased [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
